...
class Employee(Company):
    ...
    def search_employee(self, name):
        if name in self.employee_data:
            ...
            print("Employee's Roll No.: ", data[0])
            print("Employee works for Company:", data[1])
            print("Employee works in Department:", data[2])
            print("Employee's Designation:", data[3])
            print("Employee's Monthly Salary: Rs", data[4])
            print("Employee's Monthly Working Hours:", data[5])
        else:
